...
public class BenchmarkMatrixBikeyMapRead {
    ...
    public void setup() throws IOException {
        map = new MatrixBikeyMap<Integer, Integer, String>();
